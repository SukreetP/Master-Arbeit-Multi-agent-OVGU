...
com_obj.loadModel("C:\\Users\\sukreet.pal\\PycharmProjects\\thesis\\DQN prioritized replay buffer single part carry experiment\\single_part_test.spp".format(mod_path))
...
class Agent:
    ...
    def train(self, epochs, num_of_steps):
        ...
        for j in range(epochs):
            ...
            elif current_rewards_mean_agv_3 > best_reward_mean_agv3:
    ...
    def experiment(self, num_episodes):
        self.model1.load_model("dqn_AGVdeadlock_1.h5")
        self.model2.load_model("dqn_AGVdeadlock_2.h5")
        self.model3.load_model("dqn_AGVdeadlock_3.h5")
        com_obj.resetSimulation(".Models.Model")
        com_obj.startSimulation(".Models.Model")
        ...
        for episode in range(1, num_episodes + 1):
            ...
            while True:
                ...
                if done:
                    print(f"Step: {episode} Reward_agv_1: {Reward_AGV1} Reward_agv_2: {Reward_AGV2} Reward_agv_3: {Reward_AGV3} ")
                    break
...
if __name__ == "__main__":
    ...
    agent = Agent(env)
    #time.sleep(5.0)
    #agent.train(epochs=200, num_of_steps=2000)
    agent.experiment(num_episodes=1000)
    env.close()
