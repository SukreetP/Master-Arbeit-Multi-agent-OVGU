...
plt.plot(epochs, drive_time_a1,color ='green', label='drive time episode agent 1')
plt.plot(epochs, drive_time_a2,color ='red', label='drive time episode agent 2')
plt.plot(epochs, drive_time_a3,color ='blue', label='drive time episode agent 3')
plt.xlabel('Episodes')
