...
com_obj.loadModel("C:\\Users\\Sukreet\\Thesis\\custom environment\\updated_implementation\\git(with_453_train)\\test_marl.spp".format(mod_path))
        ...
        for j in range(epochs):
            ...
            for episode in range(1, num_of_steps + 1):
                ...
                while True:
                    ...
                    self.total_reward = com_obj.getValue(".Models.Model.RL")

                    eps.append(episode)
                    rews.append(self.total_reward)
                    ...
                    print(f"Step: {episode} Reward: {self.total_reward} Epsilon: {self.epsilon}")
                    break

            last_rewards.append(self.total_reward)
            ...
            mem1.append(self.total_reward)
            file1 = open("Rewards_train.txt", "a")
            print(self.total_reward, file=file1)
            file1.close()
