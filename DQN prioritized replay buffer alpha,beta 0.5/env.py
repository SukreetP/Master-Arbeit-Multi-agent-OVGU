...
class CustomEnv(Env):
    ...
    def step(self,action_a1,action_a2,action_a3):
        ...
        #self.plant_sim.executeSimTalk(".Models.Model.RL:=0")
        ...
        while True:
            ...
            if done == True:
                ...
                self.Reward_AGV1 = self.plant_sim.getValue(".Models.Model.RewardAGV1")
                self.Reward_AGV2 = self.plant_sim.getValue(".Models.Model.RewardAGV2")
                self.Reward_AGV3 = self.plant_sim.getValue(".Models.Model.RewardAGV3")
            ...
            return self.agent1_next_state, self.agent2_next_state, self.agent3_next_state,self.Reward_AGV1,self.Reward_AGV2,self.Reward_AGV3, done, {}
