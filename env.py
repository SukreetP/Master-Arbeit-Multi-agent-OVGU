    ...
    def step(self,action_a1,action_a2,action_a3):
        ...
        while True:
            ...
            if done == True:
                ...
                #global Reward_total
                #Reward = [Reward_AGV1, Reward_AGV2, Reward_AGV3]
                self.Reward_total = self.plant_sim.getValue(".Models.Model.RL")
            ...
            return self.agent1_next_state, self.agent2_next_state, self.agent3_next_state, self.Reward_total, done, {}
