...
com_obj.loadModel("C:\\Users\\Sukreet\\Thesis\\custom environment\\updated_implementation\\all experiments and trainings\\DQN training agents seperate reward (with load time)\\best_up_MARL.spp".format(mod_path))
